...
def getBuildArea(args):
    ...
    if args.player:
        area = interfaceUtil.requestPlayerArea(size * 2, size * 2)
    elif args.coordinates:
        x0, y0, z0, x1, y1, z1 = args.coordinates
        area = interfaceUtil.setBuildArea(x0, y0, z0, x1, y1, z1)
    elif args.default:
        area = interfaceUtil.setBuildArea(0, 0, 0, size, 256, size)
    elif args.buildarea:
        area = interfaceUtil.requestBuildArea()
    else:
        area = interfaceUtil.requestBuildArea()
